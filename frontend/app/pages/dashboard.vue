<template>
  <div>
    ...
    <div class="mt-10">
      ...
      <!-- Empty -->
      <div v-else-if="allPlayers.length === 0" class="card-panel py-16 text-center">
      ...
      <div v-else class="space-y-1.5">
        <div v-for="player in allPlayers" :key="player.id"
          class="flex items-center justify-between card-panel px-5 py-4 transition-colors duration-200 hover:bg-white/[0.03]">
    ...
    <div class="mt-10 grid gap-3 sm:grid-cols-3">
      <NuxtLink :to="localePath('/shop')"
        class="group flex items-center gap-4 card-panel p-5 transition-all duration-300 hover:border-white/[0.08] hover:bg-white/[0.03]">
      ...
      <button @click="showPromoModal = true"
        class="group flex items-center gap-4 card-panel p-5 text-left transition-all duration-300 hover:border-white/[0.08] hover:bg-white/[0.03]">
    ...
    <div class="mt-10 card-panel px-6 py-5">
