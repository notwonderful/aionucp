<template>
  <div>
    <div class="mb-8">
      <h1 class="font-display text-2xl font-extrabold uppercase tracking-tight lg:text-3xl">Admin Panel</h1>
      <p class="mt-1 text-[13px] text-white/25">Manage your project</p>
    </div>
    ...
    <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
      <NuxtLink to="/admin/tickets"
        ...
        <div>
          <div class="text-[15px] font-semibold transition-colors group-hover:text-emerald-400">Tickets</div>
          <div class="mt-0.5 text-[12px] text-white/20">View and reply to support tickets</div>
        </div>
      </NuxtLink>
      ...
      <NuxtLink to="/admin/users"
        ...
        <div>
          <div class="text-[15px] font-semibold transition-colors group-hover:text-sky-400">Users</div>
          <div class="mt-0.5 text-[12px] text-white/20">Manage users, roles and bans</div>
        </div>
      </NuxtLink>
      ...
      <NuxtLink to="/admin/products"
        ...
        <div>
          <div class="text-[15px] font-semibold transition-colors group-hover:text-red-400">Products</div>
          <div class="mt-0.5 text-[12px] text-white/20">Shop items and categories</div>
        </div>
      </NuxtLink>
    </div>
  </div>
